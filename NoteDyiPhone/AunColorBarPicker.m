...
#import "AunColorIndicatorView.h"
#import "AunHSBSupport.h"
...
@implementation AunColorBarView
...
@implementation AunColorBarPicker {
	AunColorIndicatorView* indicator;
}
...
- (void) layoutSubviews
{
	if (indicator == nil) {
		...
		indicator = [[AunColorIndicatorView alloc] initWithFrame: CGRectMake(0, 0, kIndicatorSize, kIndicatorSize)];
